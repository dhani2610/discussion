    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <hr>
                    <h4 class="header-title text-center">Materi</h4>
                    <hr>
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    placeholder="Cover" value="" data-default-file="" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <input required type="text" class="form-control" id="judul" name="judul" placeholder="" value="">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="name">Created BY</label>
                                    <input readonly type="text" value="{{ Auth::guard('admin')->user()->name }}" class="form-control" id="nama_petugas" name="nama_petugas" placeholder="" value="">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <textarea name="content" required class="summernote form-control" id="" cols="30" rows="50"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
