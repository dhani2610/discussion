...
<div class="main-content-inner">
    ...
    <div class="row">
        <!-- data table start -->
        <form action="{{ route('pertanyaan.store',$materi->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <hr>
                    <h4 class="header-title text-center">Pertanyaan</h4>
                    <hr>
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    <textarea name="pertanyaan" required class="summernote form-control" id="" cols="30" rows="50"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
